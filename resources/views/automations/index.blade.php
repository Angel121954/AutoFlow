<x-app-layout>
            ...
            <div class="af-card__body">
                <div class="af-empty-state">
                    <div class="af-empty-state__icon">
                        <svg width="30" height="30" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.4">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z"/>
                        </svg>
                    </div>
                    <h3>Sin automatizaciones aún</h3>
                    <p>Crea tu primera automatización para empezar a ahorrar tiempo en tus procesos de negocio</p>
                    <a href="{{ route('automations.create') }}" class="af-btn af-btn--primary">
                ...
                <div class="af-automation-card__footer">
                    ...
                    <div class="af-automation-card__actions">
                        ...
                        <a href="{{ route('automations.show', $automation) }}"
                           class="af-automation-card__action-btn"
                           title="Ver detalle">
                        ...
                        <form method="POST" action="{{ route('automations.destroy', $automation) }}"
                            ...
                            @method('DELETE')
                            <button type="submit"
                                    class="af-automation-card__action-btn af-automation-card__action-btn--danger"
                                    title="Eliminar">
                                <svg width="14" height="14" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <script>
        ...
        function setFilter(status, btn) {
            ...
            document.querySelectorAll('.af-filter-pill').forEach(p => p.classList.remove('af-filter-pill--active'));
        ...
        function applyFilters() {
            ...
            const cards   = document.querySelectorAll('.af-automation-card');
            ...
            cards.forEach(card => {
                ...
                const matchTrigger = !currentTrigger || trigger === currentTrigger;
