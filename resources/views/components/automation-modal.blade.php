{{--
    ...
    JS: public/js/app/automations.js (sin onclick en el HTML)
--}}

@push('styles')
    <link rel="stylesheet" href="{{ asset('css/modals/automation-modal.css') }}">
@endpush
...
<div class="af-modal-backdrop" id="af-automation-modal">
    ...
    <div class="af-modal-box" role="dialog" aria-modal="true" aria-labelledby="af-modal-title">
        ...
        {{-- Formulario --}}
        <form id="af-automation-form" method="POST" action="{{ route('automations.store') }}" novalidate>
            @csrf
